...
# -----------------------------------------------------------------------------
#
# GWVET documentation build configuration file, created by
...
import gwvet
from gwvet import version as gwvet_version
...
version = gwvet_version.version
# The full version, including alpha/beta/rc tags.
release = gwvet_version.version
...
def linkcode_resolve(domain, info):
    ...
    fn = os.path.relpath(fn, start=os.path.dirname(gwvet.__file__))
    if fn.startswith(os.path.pardir):
        return None

    tag = gwvet_version.git_tag or gwvet_version.git_branch
    return ("http://github.com/gwpy/gwvet/tree/%s/gwvet/%s%s"
            % (tag, fn, linespec))
